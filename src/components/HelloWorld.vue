  <template>
    <div class="hello">
        <nav class="navbar navbar-expand-sm mt-5 navbar-dark bg-dark">
          <div class="container navbar-header">
              <div class="navbar-brand" >JustPost</div>   
              <button class="navbar-toggler " data-target="#first" data-toggle="collapse" style="margin-left:220px; margin-top:-40px;" >
              ...
              <div class="navbar-collapse collapse" id="first">
                  <div class=" navbar-nav">  
                    <div class="nav-item mb-2">
                      <button class="btn rounded-circle px-3" :data-target="try2" data-toggle="modal" alt="add post" style="font-size:25px;">+</button>
                    </div> 
                    <div class=" form-inline nav-item ml-3">
                      <input type="text" class="form-control" v-model="search"/>
                    <button class="btn btn-danger" @click="fillIt()" >Search</button>
                    </div> 
                    <div class=" mt-2 nav-item ml-3">
                      <button class="btn btn-danger" @click="badha()" >All</button>
                    </div>
                    <div class=" mt-2 nav-item">
                      <button class="btn bnt-danger ml-3" @click="next()">Next</button>
                    </div>
                  </div>
              </div>
            </div>  
    ...
    methods:{
      ...
      fillIt(){
        ...
        if(this.search === null){
          ...
          return val.descript.match(this.search) || val.title.match(this.search);
        })  
